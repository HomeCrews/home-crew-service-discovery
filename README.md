# home-crew-service-discovery

Eureka registry. Every other service registers here and finds its peers.
...
| Java package | `com.homecrew.servicediscovery` |
| Maven artifact | `servicediscovery` |
| Image | `mthanuj/homecrew-service-discovery:dev` |
| Compose service | `service-discovery` |
| Database | none |
| Default branch | `dev` |
...
A push to `dev` builds the image and pushes two tags to Docker Hub:
    ...
    mthanuj/homecrew-service-discovery:dev
    mthanuj/homecrew-service-discovery:sha-<short>
